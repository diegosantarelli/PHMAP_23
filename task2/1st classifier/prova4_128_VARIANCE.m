function [featureTable,outputTable] = prova4_128_VARIANCE(inputData)
...
% Auto-generated by MATLAB on 27-Feb-2025 12:20:25
...
while hasdata(outputEnsemble)
    ...
    for ct = 1:height(intervals)
        ...
        try
            ...
            % Concatenate signal features.
            featureValues = [ClearanceFactor,ImpulseFactor,PeakValue,Std];

            % Store computed features in a table.
            featureNames = {'ClearanceFactor','ImpulseFactor','PeakValue','Std'};
        ...
        try
            ...
            % Concatenate signal features.
            featureValues = PeakFreq5;

            % Store computed features in a table.
            featureNames = {'PeakFreq5'};
...
selectedFeatureNames = ["FRM_1/Case_sigstats/ClearanceFactor","FRM_1/Case_sigstats/CrestFactor","FRM_1/Case_sigstats/ImpulseFactor","FRM_1/Case_sigstats/PeakValue","FRM_1/Case_sigstats/ShapeFactor","FRM_1/Case_sigstats/Std","FRM_1/Case_sigstats_1/ClearanceFactor","FRM_1/Case_sigstats_1/CrestFactor","FRM_1/Case_sigstats_1/ImpulseFactor","FRM_1/Case_sigstats_1/PeakValue","FRM_1/Case_sigstats_1/ShapeFactor","FRM_1/Case_sigstats_1/Std","FRM_1/Case_sigstats_2/ClearanceFactor","FRM_1/Case_sigstats_2/ImpulseFactor","FRM_1/Case_sigstats_2/PeakValue","FRM_1/Case_sigstats_2/Std","FRM_1/Case_sigstats_3/ClearanceFactor","FRM_1/Case_sigstats_3/CrestFactor","FRM_1/Case_sigstats_3/ImpulseFactor","FRM_1/Case_sigstats_3/PeakValue","FRM_1/Case_sigstats_3/ShapeFactor","FRM_1/Case_sigstats_3/Std","FRM_1/Case_sigstats_4/ClearanceFactor","FRM_1/Case_sigstats_4/CrestFactor","FRM_1/Case_sigstats_4/ImpulseFactor","FRM_1/Case_sigstats_4/PeakValue","FRM_1/Case_sigstats_4/ShapeFactor","FRM_1/Case_sigstats_4/Std","FRM_1/Case_sigstats_5/ClearanceFactor","FRM_1/Case_sigstats_5/CrestFactor","FRM_1/Case_sigstats_5/ImpulseFactor","FRM_1/Case_sigstats_5/PeakValue","FRM_1/Case_sigstats_6/ClearanceFactor","FRM_1/Case_sigstats_6/CrestFactor","FRM_1/Case_sigstats_6/ImpulseFactor","FRM_1/Case_sigstats_6/PeakValue","FRM_1/Case_sigstats_6/ShapeFactor","FRM_1/Case_sigstats_6/Std","FRM_1/Case_ps_2_spec/PeakFreq5","FRM_1/Case_ps_4_spec/PeakFreq2"];
