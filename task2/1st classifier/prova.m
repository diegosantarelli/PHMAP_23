function [featureTable,outputTable] = prova(inputData)
...
% Frame Policy:
%  Frame name: FRM_1
%  Frame size: 0.384 seconds
%  Frame rate: 0.384 seconds
%
...
% Auto-generated by MATLAB on 13-Mar-2025 15:28:11
...
while hasdata(outputEnsemble)
    ...
    fullIntervals = frameintervals([lowerBound upperBound],0.384,0.384,'FrameUnit',"seconds");
    ...
    for ct = 1:height(intervals)
        ...
        try
            ...
            featureValues = [ClearanceFactor,CrestFactor,ImpulseFactor,Kurtosis,Mean,PeakValue,ShapeFactor,Std];

            % Store computed features in a table.
            featureNames = {'ClearanceFactor','CrestFactor','ImpulseFactor','Kurtosis','Mean','PeakValue','ShapeFactor','Std'};
        ...
        try
            ...
            % Concatenate signal features.
            featureValues = [ClearanceFactor,CrestFactor,ImpulseFactor,PeakValue,Std];

            % Store computed features in a table.
            featureNames = {'ClearanceFactor','CrestFactor','ImpulseFactor','PeakValue','Std'};
        ...
        try
            ...
            % Concatenate signal features.
            featureValues = [ClearanceFactor,CrestFactor,ImpulseFactor,Kurtosis,PeakValue];

            % Store computed features in a table.
            featureNames = {'ClearanceFactor','CrestFactor','ImpulseFactor','Kurtosis','PeakValue'};
        ...
        try
            ...
            w = factor*w;
            mask_1 = (w>=factor*1.59154943091895e-05) & (w<=factor*500.000000000046);
            ps = ps(mask_1);
            w = w(mask_1);
...
selectedFeatureNames = ["FRM_1/Case_sigstats/ClearanceFactor","FRM_1/Case_sigstats/CrestFactor","FRM_1/Case_sigstats/ImpulseFactor","FRM_1/Case_sigstats/Kurtosis","FRM_1/Case_sigstats/Mean","FRM_1/Case_sigstats/PeakValue","FRM_1/Case_sigstats/ShapeFactor","FRM_1/Case_sigstats/Std","FRM_1/Case_sigstats_1/ClearanceFactor","FRM_1/Case_sigstats_1/CrestFactor","FRM_1/Case_sigstats_1/ImpulseFactor","FRM_1/Case_sigstats_1/Mean","FRM_1/Case_sigstats_1/PeakValue","FRM_1/Case_sigstats_1/ShapeFactor","FRM_1/Case_sigstats_1/Std","FRM_1/Case_sigstats_2/ClearanceFactor","FRM_1/Case_sigstats_2/CrestFactor","FRM_1/Case_sigstats_2/ImpulseFactor","FRM_1/Case_sigstats_2/PeakValue","FRM_1/Case_sigstats_2/Std","FRM_1/Case_sigstats_3/ClearanceFactor","FRM_1/Case_sigstats_3/CrestFactor","FRM_1/Case_sigstats_3/ImpulseFactor","FRM_1/Case_sigstats_3/Kurtosis","FRM_1/Case_sigstats_3/PeakValue","FRM_1/Case_sigstats_4/ClearanceFactor","FRM_1/Case_sigstats_4/CrestFactor","FRM_1/Case_sigstats_4/ImpulseFactor","FRM_1/Case_sigstats_4/Kurtosis","FRM_1/Case_sigstats_4/Mean","FRM_1/Case_sigstats_4/PeakValue","FRM_1/Case_sigstats_4/ShapeFactor","FRM_1/Case_sigstats_4/Std","FRM_1/Case_sigstats_5/ClearanceFactor","FRM_1/Case_sigstats_5/CrestFactor","FRM_1/Case_sigstats_5/ImpulseFactor","FRM_1/Case_sigstats_5/PeakValue","FRM_1/Case_sigstats_6/ClearanceFactor","FRM_1/Case_sigstats_6/CrestFactor","FRM_1/Case_sigstats_6/ImpulseFactor","FRM_1/Case_sigstats_6/PeakValue","FRM_1/Case_sigstats_6/Std","FRM_1/Case_ps_4_spec/PeakFreq2"];
