function [featureTable,outputTable] = prova1_VARIANCE(inputData)
...
% Auto-generated by MATLAB on 27-Feb-2025 11:54:13
...
while hasdata(outputEnsemble)
    ...
    for ct = 1:height(intervals)
        ...
        try
            ...
            featureValues = [ClearanceFactor,ImpulseFactor,Mean,PeakValue];

            % Store computed features in a table.
            featureNames = {'ClearanceFactor','ImpulseFactor','Mean','PeakValue'};
        ...
        try
            ...
            % Concatenate signal features.
            featureValues = [ClearanceFactor,ImpulseFactor,Mean,PeakValue,ShapeFactor,Std];

            % Store computed features in a table.
            featureNames = {'ClearanceFactor','ImpulseFactor','Mean','PeakValue','ShapeFactor','Std'};
        ...
        try
            ...
            % Concatenate signal features.
            featureValues = [ClearanceFactor,ImpulseFactor,PeakValue];

            % Store computed features in a table.
            featureNames = {'ClearanceFactor','ImpulseFactor','PeakValue'};
        ...
        try
            ...
            % Concatenate signal features.
            featureValues = [CrestFactor,ImpulseFactor,Mean,PeakValue,ShapeFactor,Std];

            % Store computed features in a table.
            featureNames = {'CrestFactor','ImpulseFactor','Mean','PeakValue','ShapeFactor','Std'};
...
selectedFeatureNames = ["FRM_1/Case_sigstats/ClearanceFactor","FRM_1/Case_sigstats/ImpulseFactor","FRM_1/Case_sigstats/Mean","FRM_1/Case_sigstats/PeakValue","FRM_1/Case_sigstats_1/ClearanceFactor","FRM_1/Case_sigstats_1/CrestFactor","FRM_1/Case_sigstats_1/ImpulseFactor","FRM_1/Case_sigstats_1/Mean","FRM_1/Case_sigstats_1/PeakValue","FRM_1/Case_sigstats_1/ShapeFactor","FRM_1/Case_sigstats_1/Std","FRM_1/Case_sigstats_2/ClearanceFactor","FRM_1/Case_sigstats_2/ImpulseFactor","FRM_1/Case_sigstats_2/Mean","FRM_1/Case_sigstats_2/PeakValue","FRM_1/Case_sigstats_2/ShapeFactor","FRM_1/Case_sigstats_2/Std","FRM_1/Case_sigstats_3/ClearanceFactor","FRM_1/Case_sigstats_3/CrestFactor","FRM_1/Case_sigstats_3/ImpulseFactor","FRM_1/Case_sigstats_3/PeakValue","FRM_1/Case_sigstats_4/ClearanceFactor","FRM_1/Case_sigstats_4/CrestFactor","FRM_1/Case_sigstats_4/ImpulseFactor","FRM_1/Case_sigstats_4/Mean","FRM_1/Case_sigstats_4/PeakValue","FRM_1/Case_sigstats_4/RMS","FRM_1/Case_sigstats_4/ShapeFactor","FRM_1/Case_sigstats_4/Std","FRM_1/Case_sigstats_5/ClearanceFactor","FRM_1/Case_sigstats_5/ImpulseFactor","FRM_1/Case_sigstats_5/PeakValue","FRM_1/Case_sigstats_6/CrestFactor","FRM_1/Case_sigstats_6/ImpulseFactor","FRM_1/Case_sigstats_6/Mean","FRM_1/Case_sigstats_6/PeakValue","FRM_1/Case_sigstats_6/ShapeFactor","FRM_1/Case_sigstats_6/Std","FRM_1/Case_ps_spec/PeakFreq4","FRM_1/Case_ps_1_spec/PeakFreq3","FRM_1/Case_ps_4_spec/PeakFreq2"];
