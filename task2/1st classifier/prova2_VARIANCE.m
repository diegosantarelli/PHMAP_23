function [featureTable,outputTable] = prova2_VARIANCE(inputData)
...
% Auto-generated by MATLAB on 27-Feb-2025 11:59:14
...
while hasdata(outputEnsemble)
    ...
    for ct = 1:height(intervals)
        ...
        try
            ...
            % Concatenate signal features.
            featureValues = [ClearanceFactor,ImpulseFactor];

            % Store computed features in a table.
            featureNames = {'ClearanceFactor','ImpulseFactor'};
