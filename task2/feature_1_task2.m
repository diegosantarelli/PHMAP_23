...
% Auto-generated by MATLAB on 13-Feb-2025 12:05:41
...
while hasdata(outputEnsemble)
    ...
    % Read signals.
    Case_full = readMemberData(member,"Case",["TIME","P1","P2","P4","P5","P6","P7"]);
    ...
    for ct = 1:height(intervals)
        ...
        try
            ...
            % Concatenate signal features.
            featureValues = [ClearanceFactor,PeakValue];

            % Store computed features in a table.
            featureNames = {'ClearanceFactor','PeakValue'};
        ...
        try
            ...
            % Concatenate signal features.
            featureValues = ClearanceFactor;

            % Store computed features in a table.
            featureNames = {'ClearanceFactor'};
...
selectedFeatureNames = ["FRM_1/Case_sigstats_4/ClearanceFactor","FRM_1/Case_sigstats_4/ImpulseFactor","FRM_1/Case_sigstats_4/CrestFactor","FRM_1/Case_sigstats_4/PeakValue","FRM_1/Case_sigstats/ClearanceFactor","FRM_1/Case_sigstats_6/ClearanceFactor","FRM_1/Case_sigstats/ImpulseFactor","FRM_1/Case_sigstats/PeakValue","FRM_1/Case_sigstats/CrestFactor","FRM_1/Case_sigstats_6/ImpulseFactor","FRM_1/Case_sigstats/Std","FRM_1/Case_sigstats_6/CrestFactor","FRM_1/Case_sigstats/ShapeFactor","FRM_1/Case_sigstats_6/PeakValue","FRM_1/Case_sigstats_5/ClearanceFactor","FRM_1/Case_sigstats_3/PeakValue","FRM_1/Case_sigstats_1/ClearanceFactor"];
