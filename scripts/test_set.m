...
for i = 1:length(test_files)
    ...
    % Supponendo che tu voglia mantenere i dati di ogni caso come una sottotabella
    % oppure sintetizzare le feature altrimenti
...
test_set_task1 = test_data_table(:, {'Case', 'Spacecraft'});
